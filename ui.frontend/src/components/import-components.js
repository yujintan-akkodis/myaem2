...
MapTo('myaem2/components/title')(TitleV2, {isEmpty: TitleV2IsEmptyFn});


MapTo('myaem2/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('myaem2/components/navigation')(NavigationV1);
MapTo('myaem2/components/languagenavigation')(LanguageNavigationV1);


MapTo('myaem2/components/tabs')(TabsV1, {isEmpty: TabsV1IsEmptyFn});
MapTo('myaem2/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('myaem2/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
MapTo('myaem2/components/container')(ContainerV1, {isEmpty: ContainerV1IsEmptyFn});
...
MapTo('myaem2/components/text')(LazyTextComponent, TextEditConfig);